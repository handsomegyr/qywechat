...
class Service
{
     ...
     */
    public function getRegisterCode($provider_access_token, \Qyweixin\Model\Service\Register $register)
    {
     ...
     * 获取媒体处理对象
     *
     * @return \Qyweixin\Manager\Service\Media
     */
     ...
     * 获取批量处理对象
     *
     * @return \Qyweixin\Manager\Service\Batch
     */
     ...
     * 获取通讯录对象
     *
     * @return \Qyweixin\Manager\Service\Contact
     */
