...
class MomentStrategy
{
	...
	// 接口地址
	private $_url = 'https://qyapi.weixin.qq.com/cgi-bin/externalcontact/moment_strategy/';
	private $_client;
	private $_request;
	 ...
	 * strategy_id 规则组id
	 */
	public function create(\Qyweixin\Model\ExternalContact\MomentStrategy $momentStrategy)
	{
		$params = $momentStrategy->getParams();
	 ...
	 * errmsg 对返回码的文本描述内容
	 */
	public function edit(\Qyweixin\Model\ExternalContact\MomentStrategy $momentStrategy)
	{
		$params = $momentStrategy->getParams();
