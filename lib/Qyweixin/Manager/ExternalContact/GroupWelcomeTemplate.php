...
class GroupWelcomeTemplate
{
     ...
     * template_id 欢迎语素材id
     */
    public function add(\Qyweixin\Model\ExternalContact\GroupWelcomeTemplate $groupWelcomeTemplate)
    {
     ...
     * errmsg 对返回码的文本描述内容
     */
    public function edit(\Qyweixin\Model\ExternalContact\GroupWelcomeTemplate $groupWelcomeTemplate)
    {
        $params = $groupWelcomeTemplate->getParams();
