...
class Appchat
{
     ...
     */
    public function create(\Qyweixin\Model\Appchat $appchat)
    {
     ...
     * errmsg 对返回码的文本描述内容
     */
    public function update(\Qyweixin\Model\Appchat $appchat)
    {
        $params = $appchat->getParams();
     ...
     * }
     */
    public function send(\Qyweixin\Model\AppchatMsg\Base $message)
    {
